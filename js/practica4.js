...
function update()
{
    ...
    pinzaIzquierda.position.set(pinzaX, pinzaY, pinzaIzquierdaZ + effectController.separacionPinza);
    pinzaDerecha.position.set(pinzaX, pinzaY, pinzaDerechaZ - effectController.separacionPinza);
