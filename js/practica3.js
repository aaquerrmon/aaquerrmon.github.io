...
// Cámara cenital
let cameraCenital;
const L = 100;//lado de las miniventanas
...
function setOrtographicCameras(ar)
{
    ...
    if (ar > 1)
    {
        camaraOrtografica = new THREE.OrthographicCamera(-L, L, L, -L, -220, 220);
    }
    else
    {
        camaraOrtografica = new THREE.OrthographicCamera(-L, L, L, -L, -220, 220);
...
function loadScene()
{
    const materialRobot = new THREE.MeshNormalMaterial({wireframe : false, flatShading: true, side: THREE.DoubleSide});
